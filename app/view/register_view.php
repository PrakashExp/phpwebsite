				...
				<div class="col-sm-5">
					<div class="signup-form"><!--sign up form-->
                        ...
                        <input type="hidden" name="GroupId" value="0" />
							<input type="text" id="Username" name="Username" placeholder="Tên đăng nhập" value="<?php echo $_POST['Username'];?>" />
                            ...
                            <br>
                            <br>
							<input type="password" id="Password" name="Password" placeholder="Mật khẩu" value="<?php echo $_POST['Password'];?>" />
							<div id="PasswordErr"></div>
							<input type="password" id="PasswordRetype" name="PasswordRetype" placeholder="Nhập lại mật khẩu" value="<?php echo $_POST['PasswordRetype']; ?>" />
