    ...
    <div class='container'>
        <div class='panel panel-primary dialog-panel'>
          <div class='panel-heading'>
            <h4 style="text-align:center">Chỉnh sửa sản phẩm</h4>
          </div>
          <div class='panel-body'>
            <form class='form-horizontal' role='form' action="#" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                <label class="control-label col-md-2 col-md-offset-2" for="productName">Mã sản phẩm</label>
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="col-md-7">
                      <input class="form-control" id="productName" name="productName" type="text" disabled="disabled" value="<?php echo @$ProductID; ?>"/>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="col-md-7">
                      <input class="form-control" id="productName" name="productName" type="text" required="required" value="<?php echo @$ProductName; ?>">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="col-md-4">
                      ...
                      <img alt="Image" src="<?php echo '../' . @$LinkImage; ?>" width="300px" height="300px" />
                    </div>
                  </div>
                </div>
              </div>
